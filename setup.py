...
setup(
    ...
    description         = 'Data Feeding API Service',
    # 배포하는 사람의 이름을 작성합니다.
    author              = 'KoreaPDS',
    # 배포하는 사람의 메일주소를 작성합니다.
    author_email        = 'koreapds@koreapds.com',
    # 배포하는 패키지의 url을 적어줍니다. 보통 github 링크를 적습니다.
    url                 = 'https://github.com/koreapds/kpds_package',
    # 배포하는 패키지의 다운로드 url을 적어줍니다.
    download_url        = 'https://github.com/koreapds/kpds_package/archive/master.zip',
    ...
    # 패키지의 키워드를 적습니다.
    keywords            = ['kpds_api', 'kpds_package', 'kpds'],
